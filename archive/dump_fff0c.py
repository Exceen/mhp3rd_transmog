#!/usr/bin/env python3
"""Dump 0x088FFF0C function and understand its arguments."""
...
# Dump 0x088FFF0C
print("=== 0x088FFF0C function ===")
for addr in range(0x088FFF0C, 0x088FFF0C + 0x200, 4):
...
# Also dump 0x088FF8F0 (the function that 0x088FFF0C calls)
print("\n=== 0x088FF8F0 function (called by 0x088FFF0C) ===")
for addr in range(0x088FF8F0, 0x088FF8F0 + 0x300, 4):
    off = psp_to_offset(addr)
    if off + 4 > len(data): break
    instr = read_u32(data, off)
    d = disasm(instr, addr)
