#!/usr/bin/env python3
"""Dump the sharpness render function at 0x09D71F38 and trace its call chain."""
...
# Dump 0x09D71F38 function
print("=== Sharpness render method at 0x09D71F38 ===")
for addr in range(0x09D71F38, 0x09D71F38 + 600, 4):
...
# Also check: what about the vtable method at +0xDC (0x09D61878)?
# This was called from the sharpness area code too
print(f"\n=== Vtable method +0xDC at 0x09D61878 ===")
for addr in range(0x09D61878, 0x09D61878 + 200, 4):
    off = psp_to_offset(addr)
    instr = read_u32(data, off)
    d = disasm(instr, addr)
    m = ""
...
# Also look at vtable+0x34 = 0x09D617B0 (this is interesting because
# the HP bar code cave hooks at return addr 0x09D61830 which is inside this area)
print(f"\n=== Vtable method +0x34 at 0x09D617B0 ===")
for addr in range(0x09D617B0, 0x09D617B0 + 200, 4):
    off = psp_to_offset(addr)
    instr = read_u32(data, off)
    d = disasm(instr, addr)
    m = ""
