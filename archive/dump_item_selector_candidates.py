#!/usr/bin/env python3
"""Dump candidate functions for item selector rendering."""
...
def dump_func(start, max_instrs, title):
    print(f"\n{'='*70}")
    print(f"=== {title} ===")
    print(f"{'='*70}")
    jr_count = 0
...
# Dump parent function around the item selector area (after player list, before end)
dump_func(0x09D6C960, 80, "PARENT 0x09D6C960+ (after player list)")

# Top candidates for item selector
candidates = [
    (0x09D69938, "0x09D69938 (called at 0x09D6C97C)"),
    (0x09D60D88, "0x09D60D88 (8x BG_BF0, called at 0x09D6C988)"),
    (0x09D643B0, "0x09D643B0 (called at 0x09D6C5B4)"),
    (0x09D645FC, "0x09D645FC (called at 0x09D6C5C4)"),
    (0x09D68040, "0x09D68040 (called at 0x09D6C5D4)"),
    (0x09D67AEC, "0x09D67AEC (called at 0x09D6C5E4)"),
    (0x09D61AEC, "0x09D61AEC (called at 0x09D6C6F4)"),
    (0x09D627B4, "0x09D627B4 (called at 0x09D6C7D8)"),
]

for start, title in candidates:
    dump_func(start, 200, title)
