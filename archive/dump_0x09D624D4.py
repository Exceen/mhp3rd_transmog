#!/usr/bin/env python3
"""Dump 0x09D624D4 which LOOP2 tail-calls for HP bar rendering."""
...
# Dump 0x09D624D4 fully
print("=== 0x09D624D4 (LOOP2 RENDER TARGET) FULL DUMP ===")
jr_count = 0
for addr in range(0x09D624D4, 0x09D627B4, 4):
    ...
    # Highlight $t0/$t1 setting before render calls
...
# Also look at the calling context in the PARENT more carefully
# Specifically where LOOP2 is called and what registers are set
print("\n\n=== PARENT: LOOP2 CALLING CONTEXT (0x09D6C920-0x09D6C980) ===")
for addr in range(0x09D6C920, 0x09D6C980, 4):
    off = psp_to_offset(addr)
    if off + 4 > len(data): break
    instr = read_u32(data, off)
    d = disasm(instr, addr)
