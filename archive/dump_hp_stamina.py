#!/usr/bin/env python3
"""Dump HP/stamina bar function 0x09D648AC and related functions."""
...
def dump_func(start, max_end, title):
    print(f"\n=== {title} ===")
    jr_count = 0
    for addr in range(start, max_end, 4):
        ...
        if "jal " in d and "jalr" not in d:
            ...
            elif 0x08800000 <= target <= 0x08A00000: marker = f" [EBOOT]"
...
# OWN_HP function
dump_func(0x09D648AC, 0x09D65000, "OWN HP/STAMINA (0x09D648AC)")

# Also dump the two common-path functions that render before HP
dump_func(0x09D5E8D0, 0x09D5E9C0, "COMMON1 (0x09D5E8D0)")
dump_func(0x09D5E9C0, 0x09D5F410, "COMMON2 (0x09D5E9C0)")
